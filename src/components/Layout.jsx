...
import {
  ...
  LuTriangleAlert, LuCalendarDays, LuMail, LuTrendingUp, LuInbox,
} from 'react-icons/lu'
...
const navItems = [
  ...
  { to: '/price-overrides', icon: <LuTrendingUp size={18}/>, label: 'Giá Theo Ngày' },
  ...
  { to: '/contact-messages', icon: <LuInbox size={18}/>,    label: 'Mail Phản Hồi' },
